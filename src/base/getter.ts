...
import { StageType } from "../custom-model";
import * as helpers from "../helpers";
import { DeepPartial, RoundPositionalInfo, Storage } from "../types";
...
export class BaseGetter {
    ...
    private async getPreviousMatchesFinalDoubleElimination(
        ...
        const winnerBracketFinalMatch = await this.storage.selectFirst(
            "match",
            {
